...
qualdat = read.csv("2012.csv", header=T)
...
write.csv(brixlineblup, file="2012yield-BLUPS-new.csv")
...
## BLUPS
# fit the model
brixmodel = lmer(MAT~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
...
str(brixlineblup)
# save the brixlineblup output to a separate .csv file
write.csv(brixlineblup, file="2012mat-BLUPS.csv")
...
# Linear Model with random effects for variance components
brixvarcomp = lmer(Height~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
# Extract variance components
summary(brixvarcomp)

## BLUPS
# fit the model
brixmodel= lmer(Height~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
...
str(brixlineblup)
# save the brixlineblup output to a separate .csv file
write.csv(brixlineblup, file="2012height-BLUPS.csv")
...
# Linear Model with random effects for variance components
brixvarcomp = lmer(Lodging~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
# Extract variance components
summary(brixvarcomp)

## BLUPS
# fit the model
brixmodel = lmer(Lodging~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
...
str(brixlineblup)
# save the brixlineblup output to a separate .csv file
write.csv(brixlineblup, file="2012Lodging-BLUPS.csv")
...
# Linear Model with random effects for variance components
brixvarcomp = lmer(Pro~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
# Extract variance components
summary(brixvarcomp)
...
str(brixlineblup)
# save the brixlineblup output to a separate .csv file
write.csv(brixlineblup, file="2012pro-BLUPS.csv")
...
# Linear Model with random effects for variance components
brixvarcomp = lmer(Oil~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
# Extract variance components
summary(brixvarcomp)

## BLUPS
# fit the model
brixmodel= lmer(Oil~ (1|LINE) + (1|LOC) + (1|LINE:LOC))
...
str(brixlineblup)
# save the brixlineblup output to a separate .csv file
write.csv(brixlineblup, file="2012oil-BLUPS.csv")
